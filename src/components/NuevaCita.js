...
class NuevaCita extends Component {
    ...
    //Cuando cambia un input guardo el valor en el state
    handleChange = e =>{
        this.setState({
            cita : {
                ...this.state.cita,
    ...
    handleSubmit = e => {
        ...
        //Paso los datos a App
        this.props.crearNuevaCita(nuevaCita);

        //Devuelvo al state inicial
        ...
        return (
            <div className="card mt-5 py-5">
                <div className="card-body">
                    <h2 className="card-title text-center mt-5">
